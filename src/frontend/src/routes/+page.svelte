	...
	<div class="orange-banner">
		<div>
			<div class="login">
				...
				<input
					class="user-login-{colorState === 'WHITE' ? 'white' : 'black'}"
					type="text"
					bind:value={username}
					placeholder="Username"
				/>
				<input
					class="user-password-{colorState === 'WHITE' ? 'white' : 'black'}"
					type="password"
					bind:value={password}
					placeholder="Password"
				/>
				<div>
					<button class="general-buttons-{colorState === 'WHITE' ? 'white' : 'black'}"
						>Signup</button
					>
					<button
						class="general-buttons-{colorState === 'WHITE' ? 'white' : 'black'}"
			...
			<div>
				<button
					class="general-buttons-{colorState === 'WHITE' ? 'white' : 'black'}"
					on:click={goToMainPage}>Go to main page</button
				>
				<button
					class="general-buttons-{colorState === 'WHITE' ? 'white' : 'black'}"
					on:click={toggleColor}>Toggle {colorState}</button
				>
				<button
					class="general-buttons-{colorState === 'WHITE' ? 'white' : 'black'}"
					on:click={toggleDeveloper}>Developer Work</button
				>
			</div>
